...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{var"##Ctag#8752"}(x + 0)
...
function Base.getproperty(x::Ptr{pthread_rwlock_t}, f::Symbol)
    f === :__data && return Ptr{var"##Ctag#8751"}(x + 0)
...
struct var"##Ctag#8903"
    data::NTuple{112, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#8903"}, f::Symbol)
    f === :_pad && return Ptr{NTuple{28, Cint}}(x + 0)
    f === :_kill && return Ptr{var"##Ctag#8904"}(x + 0)
    f === :_timer && return Ptr{var"##Ctag#8905"}(x + 0)
    f === :_rt && return Ptr{var"##Ctag#8906"}(x + 0)
    f === :_sigchld && return Ptr{var"##Ctag#8907"}(x + 0)
    f === :_sigfault && return Ptr{var"##Ctag#8908"}(x + 0)
    f === :_sigpoll && return Ptr{var"##Ctag#8909"}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#8903", f::Symbol)
    r = Ref{var"##Ctag#8903"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#8903"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#8903"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{siginfo}, f::Symbol)
    ...
    f === :_sifields && return Ptr{var"##Ctag#8903"}(x + 16)
    return getfield(x, f)
end
...
function Base.getproperty(x::var"##Ctag#8917", f::Symbol)
    r = Ref{var"##Ctag#8917"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#8917"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#8917"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_signing_config_aws}, f::Symbol)
    ...
    f === :flags && return Ptr{var"##Ctag#8917"}(x + 200)
...
struct var"##Ctag#8813"
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#8813"}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#8813", f::Symbol)
    r = Ref{var"##Ctag#8813"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#8813"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#8813"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{var"##Ctag#8813"}(x + 56)
    return getfield(x, f)
end
...
struct var"##Ctag#8867"
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#8867"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#8867", f::Symbol)
    r = Ref{var"##Ctag#8867"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#8867"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#8867"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_http_proxy_negotiator}, f::Symbol)
    ...
    f === :strategy_vtable && return Ptr{var"##Ctag#8867"}(x + 32)
    return getfield(x, f)
end
...
struct var"##Ctag#8883"
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#8883"}, f::Symbol)
    f === :fd && return Ptr{Cint}(x + 0)
    f === :handle && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#8883", f::Symbol)
    r = Ref{var"##Ctag#8883"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#8883"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#8883"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_io_handle}, f::Symbol)
    f === :data && return Ptr{var"##Ctag#8883"}(x + 0)
...
function Base.getproperty(x::Ptr{var"##Ctag#8822"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#8822", f::Symbol)
    r = Ref{var"##Ctag#8822"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#8822"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#8822"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_tls_ctx_options}, f::Symbol)
    ...
    f === :pkcs11 && return Ptr{var"##Ctag#8822"}(x + 152)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{var"##Ctag#8751"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#8751", f::Symbol)
    r = Ref{var"##Ctag#8751"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#8751"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#8751"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#8752"
    __lock::Cint
    __futex::Cuint
...
function Base.getproperty(x::Ptr{var"##Ctag#8752"}, f::Symbol)
    f === :__lock && return Ptr{Cint}(x + 0)
...
function Base.getproperty(x::var"##Ctag#8752", f::Symbol)
    r = Ref{var"##Ctag#8752"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#8752"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#8752"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#8904"
    si_pid::__pid_t
    si_uid::__uid_t
end
function Base.getproperty(x::Ptr{var"##Ctag#8904"}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#8904", f::Symbol)
    r = Ref{var"##Ctag#8904"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#8904"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#8904"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#8905"
    si_tid::Cint
    si_overrun::Cint
    si_sigval::sigval_t
end
function Base.getproperty(x::Ptr{var"##Ctag#8905"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#8905", f::Symbol)
    r = Ref{var"##Ctag#8905"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#8905"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#8905"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#8906"
    si_pid::__pid_t
    si_uid::__uid_t
    si_sigval::sigval_t
end
function Base.getproperty(x::Ptr{var"##Ctag#8906"}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
    f === :si_sigval && return Ptr{sigval_t}(x + 8)
    return getfield(x, f)
...
function Base.getproperty(x::var"##Ctag#8906", f::Symbol)
    r = Ref{var"##Ctag#8906"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#8906"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#8906"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#8907"
    si_pid::__pid_t
    si_uid::__uid_t
    si_status::Cint
    si_utime::__clock_t
...
function Base.getproperty(x::Ptr{var"##Ctag#8907"}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
...
function Base.getproperty(x::var"##Ctag#8907", f::Symbol)
    r = Ref{var"##Ctag#8907"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#8907"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#8907"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#8908"
    si_addr::Ptr{Cvoid}
end
function Base.getproperty(x::Ptr{var"##Ctag#8908"}, f::Symbol)
    f === :si_addr && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#8908", f::Symbol)
    r = Ref{var"##Ctag#8908"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#8908"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#8908"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#8909"
    si_band::Clong
    si_fd::Cint
end
function Base.getproperty(x::Ptr{var"##Ctag#8909"}, f::Symbol)
    f === :si_band && return Ptr{Clong}(x + 0)
    f === :si_fd && return Ptr{Cint}(x + 8)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#8909", f::Symbol)
    r = Ref{var"##Ctag#8909"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#8909"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#8909"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
