...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{var"##Ctag#23201"}(x + 0)
...
function Base.getproperty(x::Ptr{pthread_rwlock_t}, f::Symbol)
    f === :__data && return Ptr{var"##Ctag#23202"}(x + 0)
...
struct var"##Ctag#23288"
    data::NTuple{112, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#23288"}, f::Symbol)
    f === :_pad && return Ptr{NTuple{28, Cint}}(x + 0)
    f === :_kill && return Ptr{var"##Ctag#23289"}(x + 0)
    f === :_timer && return Ptr{var"##Ctag#23290"}(x + 0)
    f === :_rt && return Ptr{var"##Ctag#23291"}(x + 0)
    f === :_sigchld && return Ptr{var"##Ctag#23292"}(x + 0)
    f === :_sigfault && return Ptr{var"##Ctag#23293"}(x + 0)
    f === :_sigpoll && return Ptr{var"##Ctag#23294"}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#23288", f::Symbol)
    r = Ref{var"##Ctag#23288"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#23288"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#23288"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{siginfo}, f::Symbol)
    ...
    f === :_sifields && return Ptr{var"##Ctag#23288"}(x + 16)
    return getfield(x, f)
end
...
function Base.getproperty(x::var"##Ctag#23356", f::Symbol)
    r = Ref{var"##Ctag#23356"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#23356"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#23356"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_signing_config_aws}, f::Symbol)
    ...
    f === :flags && return Ptr{var"##Ctag#23356"}(x + 200)
...
struct var"##Ctag#23326"
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#23326"}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#23326", f::Symbol)
    r = Ref{var"##Ctag#23326"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#23326"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#23326"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{var"##Ctag#23326"}(x + 56)
    return getfield(x, f)
end
...
struct var"##Ctag#23392"
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#23392"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#23392", f::Symbol)
    r = Ref{var"##Ctag#23392"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#23392"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#23392"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_http_proxy_negotiator}, f::Symbol)
    ...
    f === :strategy_vtable && return Ptr{var"##Ctag#23392"}(x + 32)
    return getfield(x, f)
end
...
struct var"##Ctag#23279"
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#23279"}, f::Symbol)
    f === :fd && return Ptr{Cint}(x + 0)
    f === :handle && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#23279", f::Symbol)
    r = Ref{var"##Ctag#23279"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#23279"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#23279"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_io_handle}, f::Symbol)
    f === :data && return Ptr{var"##Ctag#23279"}(x + 0)
...
function Base.getproperty(x::Ptr{var"##Ctag#23333"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#23333", f::Symbol)
    r = Ref{var"##Ctag#23333"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#23333"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#23333"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_tls_ctx_options}, f::Symbol)
    ...
    f === :pkcs11 && return Ptr{var"##Ctag#23333"}(x + 152)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{var"##Ctag#23201"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#23201", f::Symbol)
    r = Ref{var"##Ctag#23201"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#23201"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#23201"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#23202"
    __lock::Cint
    __nr_readers::Cuint
...
function Base.getproperty(x::Ptr{var"##Ctag#23202"}, f::Symbol)
    f === :__lock && return Ptr{Cint}(x + 0)
...
function Base.getproperty(x::var"##Ctag#23202", f::Symbol)
    r = Ref{var"##Ctag#23202"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#23202"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#23202"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
struct var"##Ctag#23289"
    si_pid::__pid_t
    si_uid::__uid_t
end
function Base.getproperty(x::Ptr{var"##Ctag#23289"}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#23289", f::Symbol)
    r = Ref{var"##Ctag#23289"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#23289"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#23289"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#23290"
    si_tid::Cint
    si_overrun::Cint
    si_sigval::sigval_t
end
function Base.getproperty(x::Ptr{var"##Ctag#23290"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#23290", f::Symbol)
    r = Ref{var"##Ctag#23290"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#23290"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#23290"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#23291"
    si_pid::__pid_t
    si_uid::__uid_t
    si_sigval::sigval_t
end
function Base.getproperty(x::Ptr{var"##Ctag#23291"}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
    f === :si_sigval && return Ptr{sigval_t}(x + 8)
    return getfield(x, f)
...
function Base.getproperty(x::var"##Ctag#23291", f::Symbol)
    r = Ref{var"##Ctag#23291"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#23291"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#23291"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#23292"
    si_pid::__pid_t
    si_uid::__uid_t
    si_status::Cint
    si_utime::__clock_t
...
function Base.getproperty(x::Ptr{var"##Ctag#23292"}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
...
function Base.getproperty(x::var"##Ctag#23292", f::Symbol)
    r = Ref{var"##Ctag#23292"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#23292"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#23292"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#23293"
    si_addr::Ptr{Cvoid}
end
function Base.getproperty(x::Ptr{var"##Ctag#23293"}, f::Symbol)
    f === :si_addr && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#23293", f::Symbol)
    r = Ref{var"##Ctag#23293"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#23293"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#23293"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#23294"
    si_band::Clong
    si_fd::Cint
end
function Base.getproperty(x::Ptr{var"##Ctag#23294"}, f::Symbol)
    f === :si_band && return Ptr{Clong}(x + 0)
    f === :si_fd && return Ptr{Cint}(x + 8)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#23294", f::Symbol)
    r = Ref{var"##Ctag#23294"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#23294"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#23294"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
