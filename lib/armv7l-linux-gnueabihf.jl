...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{var"##Ctag#11641"}(x + 0)
...
function Base.getproperty(x::Ptr{pthread_rwlock_t}, f::Symbol)
    f === :__data && return Ptr{var"##Ctag#11643"}(x + 0)
...
struct var"##Ctag#11808"
    data::NTuple{112, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#11808"}, f::Symbol)
    f === :_pad && return Ptr{NTuple{28, Cint}}(x + 0)
    f === :_kill && return Ptr{var"##Ctag#11809"}(x + 0)
    f === :_timer && return Ptr{var"##Ctag#11810"}(x + 0)
    f === :_rt && return Ptr{var"##Ctag#11811"}(x + 0)
    f === :_sigchld && return Ptr{var"##Ctag#11812"}(x + 0)
    f === :_sigfault && return Ptr{var"##Ctag#11813"}(x + 0)
    f === :_sigpoll && return Ptr{var"##Ctag#11814"}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#11808", f::Symbol)
    r = Ref{var"##Ctag#11808"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#11808"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#11808"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{siginfo}, f::Symbol)
    ...
    f === :_sifields && return Ptr{var"##Ctag#11808"}(x + 16)
    return getfield(x, f)
end
...
function Base.getproperty(x::var"##Ctag#11821", f::Symbol)
    r = Ref{var"##Ctag#11821"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#11821"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#11821"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_signing_config_aws}, f::Symbol)
    ...
    f === :flags && return Ptr{var"##Ctag#11821"}(x + 200)
...
struct var"##Ctag#11713"
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#11713"}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#11713", f::Symbol)
    r = Ref{var"##Ctag#11713"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#11713"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#11713"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{var"##Ctag#11713"}(x + 56)
    return getfield(x, f)
end
...
struct var"##Ctag#11768"
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#11768"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#11768", f::Symbol)
    r = Ref{var"##Ctag#11768"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#11768"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#11768"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_http_proxy_negotiator}, f::Symbol)
    ...
    f === :strategy_vtable && return Ptr{var"##Ctag#11768"}(x + 32)
    return getfield(x, f)
end
...
struct var"##Ctag#11788"
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#11788"}, f::Symbol)
    f === :fd && return Ptr{Cint}(x + 0)
    f === :handle && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#11788", f::Symbol)
    r = Ref{var"##Ctag#11788"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#11788"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#11788"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_io_handle}, f::Symbol)
    f === :data && return Ptr{var"##Ctag#11788"}(x + 0)
...
function Base.getproperty(x::Ptr{var"##Ctag#11727"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#11727", f::Symbol)
    r = Ref{var"##Ctag#11727"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#11727"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#11727"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_tls_ctx_options}, f::Symbol)
    ...
    f === :pkcs11 && return Ptr{var"##Ctag#11727"}(x + 152)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{var"##Ctag#11641"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#11641", f::Symbol)
    r = Ref{var"##Ctag#11641"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#11641"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#11641"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#11643"
    __lock::Cint
    __nr_readers::Cuint
...
function Base.getproperty(x::Ptr{var"##Ctag#11643"}, f::Symbol)
    f === :__lock && return Ptr{Cint}(x + 0)
...
function Base.getproperty(x::var"##Ctag#11643", f::Symbol)
    r = Ref{var"##Ctag#11643"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#11643"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#11643"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#11809"
    si_pid::__pid_t
    si_uid::__uid_t
end
function Base.getproperty(x::Ptr{var"##Ctag#11809"}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#11809", f::Symbol)
    r = Ref{var"##Ctag#11809"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#11809"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#11809"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#11810"
    si_tid::Cint
    si_overrun::Cint
    si_sigval::sigval_t
end
function Base.getproperty(x::Ptr{var"##Ctag#11810"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#11810", f::Symbol)
    r = Ref{var"##Ctag#11810"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#11810"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#11810"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#11811"
    si_pid::__pid_t
    si_uid::__uid_t
    si_sigval::sigval_t
end
function Base.getproperty(x::Ptr{var"##Ctag#11811"}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
    f === :si_sigval && return Ptr{sigval_t}(x + 8)
    return getfield(x, f)
...
function Base.getproperty(x::var"##Ctag#11811", f::Symbol)
    r = Ref{var"##Ctag#11811"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#11811"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#11811"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#11812"
    si_pid::__pid_t
    si_uid::__uid_t
    si_status::Cint
    si_utime::__clock_t
...
function Base.getproperty(x::Ptr{var"##Ctag#11812"}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
...
function Base.getproperty(x::var"##Ctag#11812", f::Symbol)
    r = Ref{var"##Ctag#11812"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#11812"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#11812"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#11813"
    si_addr::Ptr{Cvoid}
end
function Base.getproperty(x::Ptr{var"##Ctag#11813"}, f::Symbol)
    f === :si_addr && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#11813", f::Symbol)
    r = Ref{var"##Ctag#11813"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#11813"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#11813"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#11814"
    si_band::Clong
    si_fd::Cint
end
function Base.getproperty(x::Ptr{var"##Ctag#11814"}, f::Symbol)
    f === :si_band && return Ptr{Clong}(x + 0)
    f === :si_fd && return Ptr{Cint}(x + 8)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#11814", f::Symbol)
    r = Ref{var"##Ctag#11814"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#11814"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#11814"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
