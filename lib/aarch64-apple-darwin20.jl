...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{var"##Ctag#2971"}(x + 0)
...
function Base.getproperty(x::Ptr{pthread_rwlock_t}, f::Symbol)
    f === :__data && return Ptr{var"##Ctag#2973"}(x + 0)
...
struct var"##Ctag#3127"
    data::NTuple{112, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#3127"}, f::Symbol)
    f === :_pad && return Ptr{NTuple{28, Cint}}(x + 0)
    f === :_kill && return Ptr{var"##Ctag#3128"}(x + 0)
    f === :_timer && return Ptr{var"##Ctag#3129"}(x + 0)
    f === :_rt && return Ptr{var"##Ctag#3130"}(x + 0)
    f === :_sigchld && return Ptr{var"##Ctag#3131"}(x + 0)
    f === :_sigfault && return Ptr{var"##Ctag#3132"}(x + 0)
    f === :_sigpoll && return Ptr{var"##Ctag#3133"}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#3127", f::Symbol)
    r = Ref{var"##Ctag#3127"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#3127"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#3127"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{siginfo}, f::Symbol)
    ...
    f === :_sifields && return Ptr{var"##Ctag#3127"}(x + 16)
    return getfield(x, f)
end
...
function Base.getproperty(x::var"##Ctag#3139", f::Symbol)
    r = Ref{var"##Ctag#3139"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#3139"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#3139"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_signing_config_aws}, f::Symbol)
    ...
    f === :flags && return Ptr{var"##Ctag#3139"}(x + 200)
...
struct var"##Ctag#3039"
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#3039"}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#3039", f::Symbol)
    r = Ref{var"##Ctag#3039"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#3039"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#3039"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{var"##Ctag#3039"}(x + 56)
    return getfield(x, f)
end
...
struct var"##Ctag#3099"
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#3099"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#3099", f::Symbol)
    r = Ref{var"##Ctag#3099"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#3099"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#3099"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_http_proxy_negotiator}, f::Symbol)
    ...
    f === :strategy_vtable && return Ptr{var"##Ctag#3099"}(x + 32)
    return getfield(x, f)
end
...
struct var"##Ctag#3111"
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#3111"}, f::Symbol)
    f === :fd && return Ptr{Cint}(x + 0)
    f === :handle && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#3111", f::Symbol)
    r = Ref{var"##Ctag#3111"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#3111"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#3111"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_io_handle}, f::Symbol)
    f === :data && return Ptr{var"##Ctag#3111"}(x + 0)
...
function Base.getproperty(x::Ptr{var"##Ctag#3056"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#3056", f::Symbol)
    r = Ref{var"##Ctag#3056"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#3056"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#3056"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_tls_ctx_options}, f::Symbol)
    ...
    f === :pkcs11 && return Ptr{var"##Ctag#3056"}(x + 152)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{var"##Ctag#2971"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#2971", f::Symbol)
    r = Ref{var"##Ctag#2971"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#2971"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#2971"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#2973"
    __lock::Cint
    __nr_readers::Cuint
...
function Base.getproperty(x::Ptr{var"##Ctag#2973"}, f::Symbol)
    f === :__lock && return Ptr{Cint}(x + 0)
...
function Base.getproperty(x::var"##Ctag#2973", f::Symbol)
    r = Ref{var"##Ctag#2973"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#2973"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#2973"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#3128"
    si_pid::__pid_t
    si_uid::__uid_t
end
function Base.getproperty(x::Ptr{var"##Ctag#3128"}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#3128", f::Symbol)
    r = Ref{var"##Ctag#3128"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#3128"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#3128"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#3129"
    si_tid::Cint
    si_overrun::Cint
    si_sigval::sigval_t
end
function Base.getproperty(x::Ptr{var"##Ctag#3129"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#3129", f::Symbol)
    r = Ref{var"##Ctag#3129"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#3129"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#3129"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#3130"
    si_pid::__pid_t
    si_uid::__uid_t
    si_sigval::sigval_t
end
function Base.getproperty(x::Ptr{var"##Ctag#3130"}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
    f === :si_sigval && return Ptr{sigval_t}(x + 8)
    return getfield(x, f)
...
function Base.getproperty(x::var"##Ctag#3130", f::Symbol)
    r = Ref{var"##Ctag#3130"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#3130"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#3130"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#3131"
    si_pid::__pid_t
    si_uid::__uid_t
    si_status::Cint
    si_utime::__clock_t
...
function Base.getproperty(x::Ptr{var"##Ctag#3131"}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
...
function Base.getproperty(x::var"##Ctag#3131", f::Symbol)
    r = Ref{var"##Ctag#3131"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#3131"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#3131"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#3132"
    si_addr::Ptr{Cvoid}
end
function Base.getproperty(x::Ptr{var"##Ctag#3132"}, f::Symbol)
    f === :si_addr && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#3132", f::Symbol)
    r = Ref{var"##Ctag#3132"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#3132"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#3132"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct var"##Ctag#3133"
    si_band::Clong
    si_fd::Cint
end
function Base.getproperty(x::Ptr{var"##Ctag#3133"}, f::Symbol)
    f === :si_band && return Ptr{Clong}(x + 0)
    f === :si_fd && return Ptr{Cint}(x + 8)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#3133", f::Symbol)
    r = Ref{var"##Ctag#3133"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#3133"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#3133"}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
